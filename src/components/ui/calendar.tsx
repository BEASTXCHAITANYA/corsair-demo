    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-white/70 opacity-70 hover:opacity-100 hover:text-white hover:bg-white/10",
        ),
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-normal text-white hover:bg-white/10 hover:text-white aria-selected:opacity-100",
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-[#B4F24A] text-[#0A0A0A] hover:bg-[#B4F24A] hover:text-[#0A0A0A] focus:bg-[#B4F24A] focus:text-[#0A0A0A]",
        day_today: "bg-[rgba(180,242,74,0.15)] text-[#B4F24A]",
        day_outside:
          "day-outside text-white/30 aria-selected:bg-white/10 aria-selected:text-white/30",
